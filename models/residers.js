...
const residerSchema = new Schema({
    ...
    email : {isVerified: {type :Boolean, default:false}, emailID:{type : String,required:false},resetToken : {type : String,required:false},expireToken : {type : Date,required:false}},
