...
const { getResiders,addResider,checkOut,uploadImg,addExpense,sendOtp,verifyOtp,checkIn,checkedInResiders,getImage } = require('../controller/residerController')
...
residerRouter.get('/get-image/:key',getImage)
